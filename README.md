...
Back-end Setup
---
>  **Note:** An odd number of instances is recommended for this setup to maintain a quorum number of nodes.

1. Create your nodes on AWS and distribute them among the different availability zones evenly (i.e. node1 in US-east-1a, node2 in US-east-1b, node3 in US-east-1c). 
